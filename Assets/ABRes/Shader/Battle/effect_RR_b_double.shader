Shader "Shaders/Effect/effect_RR_b_double" {
    Properties {
...
////// Emissive:
                ...
                float _Rongjie_fanzhuang_var = lerp( _intensity, (1.0 - _intensity), _Rongjie_fanzhuang );
                float _rongjie_intensity = (_Rongjie_qiangdu*lerp( i.uv1.r, 1.0, _Rongjie_qh ));
                float _fanzhuan_intensity = (_Rongjie_fanzhuang_var-_rongjie_intensity);
                float _rongjie_original = (_fanzhuan_intensity*_Rongjie_bianyuan);
                float rongjie = saturate(_rongjie_original);
